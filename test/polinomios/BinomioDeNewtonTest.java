...
public class BinomioDeNewtonTest {
    ...
    @Test
    public void desarrollCompletoRecursivoTest() {
        Assert.assertTrue(resultadoNewton1.equals(binomioNewton1.desarrolloCompletoRecursivo()));
        Assert.assertTrue(resultadoNewton2.equals(binomioNewton2.desarrolloCompletoRecursivo()));
        Assert.assertTrue(resultadoNewton3.equals(binomioNewton3.desarrolloCompletoRecursivo()));
        Assert.assertTrue(resultadoNewton4.equals(binomioNewton4.desarrolloCompletoRecursivo()));
        Assert.assertTrue(resultadoNewton5.equals(binomioNewton5.desarrolloCompletoRecursivo()));
        Assert.assertTrue(resultadoNewton6.equals(binomioNewton6.desarrolloCompletoRecursivo()));
    }

    @Test
    public void desarrolloCompletoMejoradoTest() {
        Assert.assertTrue(resultadoNewton1.equals(binomioNewton1.desarrolloCompletoMejorado()));
        Assert.assertTrue(resultadoNewton2.equals(binomioNewton2.desarrolloCompletoMejorado()));
        Assert.assertTrue(resultadoNewton3.equals(binomioNewton3.desarrolloCompletoMejorado()));
        Assert.assertTrue(resultadoNewton4.equals(binomioNewton4.desarrolloCompletoMejorado()));
        Assert.assertTrue(resultadoNewton5.equals(binomioNewton5.desarrolloCompletoMejorado()));
        Assert.assertTrue(resultadoNewton6.equals(binomioNewton6.desarrolloCompletoMejorado()));
    }
    ...
    @Test
    public void coeficienteKRecursivoTest() {

    }

    @Test
    public void coeficienteKMejradoTest() {
